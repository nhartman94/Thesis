...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=0.8\linewidth]{\figpath/saliency/mc16d_PFlow_BTagging201903_ttbar_pt_1000_d0_1_z0_1.5/Db/noNorm/img_misID_b_77WP_8trks}%12trks
    %{img_misID_b_70WP_12trks}
...
%     \centering
%     \subfloat{ 
%             \includegraphics[width=0.48\textwidth]{rocAvgIter_l_stdROC}
%     }   
%     \subfloat{ 
%             \includegraphics[width=0.48\textwidth]{rocAvgIter_c_stdROC}
%     }   
%     \caption{$b$-jet efficiency versus light-flavour jet rejection and for $b$-jet efficiency versus $c$-jet rejection of the DIPS (purple), RNNIP (green), and Optimised DIPS (orange) algorithms. The central curves and error bands show the mean and standard deviation, respectively, of the rejection at each $b$-jet efficiency of 5 trainings.}
%     \label{fig:roc_rnnip_dips_opt}
% \end{figure}
